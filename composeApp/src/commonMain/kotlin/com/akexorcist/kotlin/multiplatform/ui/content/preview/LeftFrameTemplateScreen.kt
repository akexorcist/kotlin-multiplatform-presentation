...
import com.akexorcist.kotlin.multiplatform.ui.component.template.LeftFrameTemplate
import com.akexorcist.kotlin.multiplatform.ui.component.template.RightFrameTemplate
import com.akexorcist.kotlin.multiplatform.ui.navigation.Screen
import com.akexorcist.kotlin.multiplatform.ui.theme.GradientColor

private val Route = Screen.LeftFrameTemplate.name

fun NavController.navigateToLeftFrameTemplate() {
    navigate(Route)
}

fun NavGraphBuilder.leftFrameTemplate() {
    composable(route = Route) {
        LeftFrameTemplateScreen()
    }
}

@Composable
fun LeftFrameTemplateScreen() {
        LeftFrameTemplate(
